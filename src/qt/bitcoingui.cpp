    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Quark Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Quark Core help message to get a list with possible Quark Command-line options"));
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    {
        trayIcon->setToolTip(tr("Quark client") + " " + tr("[testnet]"));
